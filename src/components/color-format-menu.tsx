...
export function ColorFormatMenu({ open, onOpenChange, colorText, anchor }: ColorFormatMenuProps) {
		...
		<MenuPrimitive.Root open={open} onOpenChange={onOpenChange}>
			<MenuPrimitive.Portal>
				...
				>
					...
					>
						<div className="px-3 py-2 text-xs text-muted-foreground">Copy color as</div>
